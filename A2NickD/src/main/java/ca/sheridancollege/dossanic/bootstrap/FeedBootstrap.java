...
public class FeedBootstrap implements CommandLineRunner {
	...
	public void run(String... args) throws Exception {
		...
		Feed f1 = new Feed("Product Team - Ringo Starr", "Q3 Project Fusion Deployed!",
		...
		Feed f2 = new Feed("R&D Department - Paul McCartney", "AI Ethics Workshop Recap",
		...
		Feed f3 = new Feed("Dev Ops Lead - Scooby Doo", "New CI/CD Pipeline Docs Available",
